  ...
  return (
    ...
    >
      <div className="relative w-full">
        ...
        >
          ...
          <div
            className={cn(
              ...
              "mx-auto max-w-304 py-10", // remove max-w-4xl if you want the carousel to span the full width of its container
            )}
          >
        ...
        <button
          className={cn("absolute cursor-pointer z-10 left-5 top-1/2 -translate-y-1/2 flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 disabled:opacity-50", canScrollLeft && "bg-primary text-white")}
          onClick={scrollLeft}
          disabled={!canScrollLeft}
        >
          <IconArrowNarrowLeft className={cn("h-6 w-6 text-white", !canScrollLeft && "text-gray-500")} />
        </button>
        <button
          className={cn("absolute cursor-pointer z-10 right-5 top-1/2 -translate-y-1/2 flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 disabled:opacity-50", canScrollRight && "bg-primary text-white")}
          onClick={scrollRight}
          disabled={!canScrollRight}
        >
          <IconArrowNarrowRight className={cn("h-6 w-6 text-white", !canScrollRight && "text-gray-500")} />
        </button>
      </div>
    </CarouselContext.Provider>
  );
